...
result="" + account;
    ...
    if(submit.equals("second"))
    {
        try
        {
accountnumber=request.getParameter("anm");
String withdrawamount=request.getParameter("wi");
int acno=Integer.parseInt(accountnumber);
int de=Integer.parseInt(withdrawamount);
BankAccount account=new BankAccount(acno);
...
<html>
    <head>
     ...
     <body style="background-color:blue;">
      ...
      <div class="col" >
       <label for="ac">Account number:</label>
      <input type="text" class="form-control"id="anm" placeholder="Enter Account number" name="anm" value="<%=accountnumber%>" required>
      <br><br>
      <label for="da">Withdraw amount:</label>
      <input type="text" class="form-control"id="wi" placeholder="Enter withdraw amount" name="wi"  required>
      <br><br>
